...
"""
    ...
    connection, cursor,_ = db.connect_to_postgres('local')
    ...
    for v in vectors:
        sql_page_vector = sql_page_vector + """   ({}, ARRAY{}),""".format(v[0], list(v[1]))
        

    sql_page_vector = sql_page_vector[:-1]
